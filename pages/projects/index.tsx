...
// The initial list of projects is now loaded statically
type Props = {
  projectsList: Array<ProjectCardProps>;
};

type TypeFilterBy = 'year' | 'priority';
...
const Projects: NextPage<Props> = () => {
  ...
  const [customOrderedProjectList, setCustomOrderedProjectList] = useState<
    ProjectCardProps[]
  >([]);
  // Changed default sort to 'priority'
    ...
    <div className="my-4 sm:my-10">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          ...
          development, from web applications to data visualizations.
        </p>
      </div>
            ...
            >
              ...
              <SelectContent>
                <SelectGroup>
                  ...
                  {/* Removed the "Stars" option */}
                  <SelectItem value="priority">Naimish's Favorites</SelectItem>
