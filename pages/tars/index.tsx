...
import nIcon from '../../images/favicon.png';
...
const SAMPLE_QUESTIONS = [
  'Can you share a recommendation from someone who has worked with Naimish?',
  "What is Naimish's education background?",
  'What are some examples of problems Naimish has solved in past roles?',
  'Can you list some projects and frameworks Naimish has worked on?',
  "What's Naimish's biggest professional achievement?",
  'How does Naimish approach problem-solving in his projects?',
  'What programming languages and technologies is Naimish most passionate about?',
  "Can you tell me about Naimish's leadership style and team collaboration?",
  'What unique skills or expertise does Naimish bring to a team?',
  'How does Naimish stay updated with the latest technology trends?',
  "What's the most challenging project Naimish has worked on?",
  "Can you describe Naimish's work philosophy and values?",
  'What industries or domains has Naimish gained experience in?',
  'How does Naimish balance technical excellence with business requirements?',
];
...
const Gpt: NextPage = () => {
  ...
  const fetchResponse = async (newQuery: string) => {
    ...
    return await fetch(`${process.env.NEXT_PUBLIC_TARS_ENDPOINT}`, {
      method: 'POST',
      headers: myHeaders,
      body: JSON.stringify({
        query: newQuery,
                ...
                {isServerUp ? (
                  <>
                    ...
                    <p className="text-muted-foreground">
                      I'm here to help you get to know Naimish better. Ask me
        ...
        <div className="py-2 flex-shrink-0">
          <div className="flex gap-2">
            <Input
              ...
              className="flex-1"
              placeholder={'Ask me anything about Naimish...'}
  ...
  return (
    <div className="flex justify-end">
      <div className="flex items-start gap-3 max-w-[80%]">
        ...
        <Avatar title="user" url={nIcon.src} width="w-8" height="h-8" />
      </div>
    </div>
  );
}
